			...
			<div class="fl preview-wrap">
				...
				<div class="zoom">
					...
					<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imageList?size>0)>
									<img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="300px"
										 height="300px"/>
                                </#if>
							</span>
					</div>
			...
			<div class="fr itemInfo-wrap">
				...
				<div class="clearfix choose">
					<div id="specification" class="summary-wrap clearfix">
						<dt>
                            <#list specList as specification>
								<dl>
									<dt>
										<div class="fl title">
                                    ...
                                    <#list specification.attributeValue as item>
										<dd>
											<a class="{{isSelected('${specification.attributeName}', '${item}') ? 'selected' : ''}}" href="javascript:;"
												ng-click="selectSpec('${specification.attributeName}', '${item}')">${item}</a>
										</dd>
                                    </#list>
								</dl>
                            </#list>
						...
						<ul class="goods-list unstyled">
							...
							<li>
								<div class="list-wrap">
									...
									<div class="operate">
										<a href="javascript:void(0);" ng-click="addToCart()" class="sui-btn btn-bordered">加入购物车</a>
									</div>
								</div>
							</li>
							<li>
						...
						<div id="one" class="tab-pane active">
							<ul class="goods-intro unstyled">
								<#if (customAttributeList??)>
									<#list customAttributeList as itme>
										<li>${itme.text!''}：${itme.value!''}</li>
									</#list>
								</#if>
							</ul>
